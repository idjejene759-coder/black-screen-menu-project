          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            ...
            <div>
              ...
              <div className="prose max-w-none mb-6">
                ...
                <p className="text-primary mb-4">Быстросъёмное соединение (квик-каплер) обеспечивает возможность оперативной замены навесного оборудования без дополнительных инструментов. Существенно сокращает время переоснащения экскаватора и повышает эффективность работы на объекте.</p>
              </div>
