...
const MachtyMsEx = () => {
  ...
  const productSchema = {
    ...
    description: "Мачты МКБЭ — навесное копрово-бурильное оборудование на экскаватор для забивки свай и бурения. Российское производство. До 4 раз дешевле импортных аналогов.",
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Мачты МКБЭ для экскаваторов. Превращают экскаватор в сваебойную или буровую установку. МКБЭ-1 и МКБЭ-2. До 4 раз дешевле импортных аналогов. Российское производство."
        keywords="мачты копровые экскаваторные, мачты МКБЭ, МКБЭ-1, МКБЭ-2, копровая мачта на экскаватор, навесное оборудование экскаватор, сваебойная установка"
        canonical="https://kgs-ural.ru/catalog/machty-ms-ex"
        ogTitle="Мачты копровые экскаваторные МКБЭ — превратите экскаватор в копровую установку"
        ogDescription="Навесное копрово-бурильное оборудование на экскаватор. МКБЭ-1 и МКБЭ-2. Забивка свай, лидерное бурение. Экономия до 4 раз по сравнению с импортом."
      />
      ...
      <Breadcrumbs items={[
        ...
        { label: "Мачты копровые экскаваторные (серия МКБЭ)", path: "/catalog/machty-ms-ex" },
      ]} />
