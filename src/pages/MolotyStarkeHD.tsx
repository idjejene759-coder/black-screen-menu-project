...
import HDHeroSection from "@/components/hd/HDHeroSection";
import HDVariantsSection from "@/components/hd/HDVariantsSection";
import HDBenefitsSection from "@/components/hd/HDBenefitsSection";
import HDDescriptionSection from "@/components/hd/HDDescriptionSection";
import HDGallerySection from "@/components/hd/HDGallerySection";
...
const MolotyStarkeHD = () => {
  const productSchema = {
    ...
    "description": "Дизельные трубчатые молоты Starke серии HD для забивки железобетонных, стальных и морских свай. Энергия удара на 30–50% выше штанговых молотов.",
    "brand": {
      "@type": "Brand",
      "name": "Starke"
    },
