          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            ...
            <div>
              ...
              <div className="prose max-w-none mb-6">
                ...
                <p className="text-primary mb-4">Удлинённая стрела позволяет увеличить глубину погружения свай и расширяет рабочую зону экскаватора. Изготавливается под конкретную модель базовой машины с учетом требуемой длины и грузоподъемности.</p>
              </div>
